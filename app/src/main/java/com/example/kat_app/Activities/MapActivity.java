...
public class MapActivity extends AppCompatActivity implements GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(getResources().getString(R.string.google_maps_api))) {
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        BitmapDescriptor customMarker =
                                BitmapDescriptorFactory.fromResource(R.drawable.ic_invest);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        com.example.kat_app.Models.MapDemoActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
